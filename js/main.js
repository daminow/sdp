import {items, categories, circleSvg, payments, createElement, dataToJson, jsonToData, getData, setData, createIconItem, createIcon, createAlertWindow, searchForm, modal} from './data.js'
